...
export const translations = {
	"de-CH": {
		...
		heroTitle2: "Obwalden",
		heroSubtitle:
			"Gsichtsschminke für Kindergeburtstäg, Fäscht und Verastaltige",
		ctaBook: "Buche jetzt",
	...
	de: {
		...
		heroTitle2: "Obwalden",
		heroSubtitle:
			"Gesichtsschminke für Kindergeburtstage, Feste und Veranstaltungen",
...
export function getTranslation(
	lang: Language,
	key: keyof (typeof translations)["de-CH"],
) {
