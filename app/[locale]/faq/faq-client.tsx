...
import { BadgeQuestionMark, ChevronDown, HelpCircle } from "lucide-react"
	...
	return (
		...
		>
			<CardHeader className="pb-4">
				<CardTitle className="text-left font-semibold text-lg">
					<button
						type="button"
						id={buttonId}
						...
						onClick={onToggle}
						className="flex w-full cursor-pointer items-center justify-between text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
					>
			...
			<div className="fade-in-element mx-auto mt-16 max-w-2xl translate-y-4 text-center opacity-0 transition-all delay-1500 duration-700">
				<Card className="border-0 bg-linear-to-br from-primary/5 via-secondary/5 to-accent/5 shadow-lg">
					<CardContent className="p-8">
						<h2 className="mb-4 font-bold text-2xl">{t("contact.title")}</h2>
